...
## Project Information
- **Project path**: c:\Users\pc\expense-management\backend\expense-backend
- **Working branch**: appmod/java-upgrade-20260209234024
...
- **Build tool path**: c:\Users\pc\expense-management\backend\expense-backend
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260209234024`.
